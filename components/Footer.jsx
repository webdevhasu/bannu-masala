      ...
      <div className={styles.inner}>
        <div className={styles.brand}>
          ...
          <div className={styles.socialLinks}>
            ...
            <a href="https://www.instagram.com/bannumasala786/" target="_blank" rel="noopener noreferrer" className={`${styles.socialLink} ${styles.ig}`}>
              <svg viewBox="0 0 448 512" fill="currentColor" height="1.1em" width="1.1em">
            ...
            <a href="https://www.tiktok.com/@bannumasala786" target="_blank" rel="noopener noreferrer" className={`${styles.socialLink} ${styles.tt}`}>
              <svg viewBox="0 0 448 512" fill="currentColor" height="1.1em" width="1.1em">
                <path d="M448 209.91a210.06 210.06 0 0 1-122.77-39.25V349.38A162.55 162.55 0 1 1 185 188.31V278.2a74.62 74.62 0 1 0 52.23 71.18V0l88 0a121.18 121.18 0 0 0 1.86 22.32c7.87 33.32 31.36 60.33 63 73.3s67.87 13.91 100 2.45v111.84z"/>
              </svg>
              TikTok
            </a>
          </div>
