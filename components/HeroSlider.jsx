...
const defaultSlides = [
  {
    id: 'def-1',
    headline: "Bannu Masala: Authentic Handcrafted Spices",
    subtext: "Taste the soul of Bannu with our centuries-old traditional spice blends. 100% natural and pure ingredients.",
    cta: "Shop Online",
    href: "/#products",
    bg: "linear-gradient(135deg, #3D0000 0%, #7B1C1C 50%, #C9932A 100%)",
    badge: "Official Bannu Masala",
    emoji: "🌶️",
  },
  {
    id: 'def-2',
    headline: "Pure Spices Delivered Across Pakistan",
    subtext: "Free delivery on all orders above Rs. 3,000. Fresh, aromatic masalas from the heart of KPK to your doorstep.",
